                ...
                <div class="row d-flex align-items-center vh-100">
                    ...
                    <div class="col-md-6 offset-1 wow animate__animated animate__bounceInRight" data-wow-duration="2s">
                        ...
                        <?php require('./include/alerts.php') ?>
                            ...
                            <form action="handlers/create-question.php" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="exampleInputname" class="form-label text-capitalize">question</label>
                                    <input type="text" name="question" class="form-control" id="exampleInputname" aria-describedby="name">
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn text-capitalize rounded-pill mt-2 py-2 px-3">add question</button>
                            </form>
                        </div>
                    </div>
                </div>
